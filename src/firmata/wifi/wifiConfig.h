...
#define STATIC_IP_ADDRESS  IPADDRESSCHANGEME
#define SUBNET_MASK        NETMASKCHANGEME // REQUIRED for ESP8266_WIFI, optional for others
#define GATEWAY_IP_ADDRESS GATEWAYCHANGEME       // REQUIRED for ESP8266_WIFI, optional for others
...
char wpa_passphrase[] = "SSIDPASSCHANGEME";
