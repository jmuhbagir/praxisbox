...
#define STATIC_IP_ADDRESS  192,168,0,2
#define SUBNET_MASK        255,255,255,0 // REQUIRED for ESP8266_WIFI, optional for others
#define GATEWAY_IP_ADDRESS 192,168,0,1       // REQUIRED for ESP8266_WIFI, optional for others
...
char wpa_passphrase[] = "vololights01";
